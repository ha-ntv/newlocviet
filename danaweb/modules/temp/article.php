...
//
function article($act, $typeFunc, $article_id, $article_menu_id, $name, $slug, $title, $description, $keywords, $img, $img_note, $comment, $content, $is_active, $hot, $created_time, $upload_img_id, $error, $link) {
	global $db, $tth;
	$category = 0;
				...
				<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
					...
					<table class="table table-hover">
						...
						<tr>
							...
							<td width="12%" align="right" class="ver-top"><label><?php if($category==75) echo 'Nghề nghiệp:';else echo 'Ghi chú hình:';?></label></td>
