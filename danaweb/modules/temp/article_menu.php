					...
					<table class="table table-hover" style="width: 70%;">
						...
						<?php 
							if($category_id==12)
							{
								?>
									<tr>
										<td align="right" class="ver-top"><label>Châu Lục *:</label></td>
										<td>
											<select name="plus" class="form-control">
												<?php 
													if($plus==0)
													{
														echo '<option value="0" selected>Châu Mỹ</option>';
													}
													else{
														echo '<option value="0">Châu Mỹ</option>';
													}

													if($plus==1)
													{
														echo '<option value="1" selected>Châu Âu</option>';
													}
													else{
														echo '<option value="1">Châu Âu</option>';
													}


													if($plus==2)
													{
														echo '<option value="2" selected>Châu Á</option>';
													}
													else{
														echo '<option value="2">Châu Á</option>';
													}

													if($plus==3)
													{
														echo '<option value="3" selected>Châu Phi</option>';
													}
													else{
														echo '<option value="3">Châu Phi</option>';
													}


													if($plus==4)
													{
														echo '<option value="4" selected>Châu Úc</option>';
													}
													else{
														echo '<option value="4">Châu Úc</option>';
													}

													if($plus==5)
													{
														echo '<option value="5" selected>Không có</option>';
													}
													else{
														echo '<option value="5">Không có</option>';
													}
