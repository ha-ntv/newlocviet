...
if(!$OK) productMenu("?".TTH_PATH."=product_menu_edit", "edit", $product_menu_id, $category_id, $name, $slug, $comment, $plus, $title, $description, $keywords, $parent, $is_active, $hot, $img, $error);