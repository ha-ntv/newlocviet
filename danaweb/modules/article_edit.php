		...
		if($OK) {
			...
			if($handleUploadImg) {
				...
				if($imgUp->processed) {
                	...
                	$imgUp->file_new_name_body    = '352x260'. $name_image;
					$imgUp->image_resize          = true;
					$imgUp->image_ratio_crop      = true;
					$imgUp->image_y               = 260;
					$imgUp->image_x               = 352;
					...
					$imgUp->file_new_name_body    = '353x232'. $name_image;
					$imgUp->image_resize          = true;
					$imgUp->image_ratio_crop      = true;
					$imgUp->image_y               = 232;
					$imgUp->image_x               = 353;
					...
					$imgUp->file_new_name_body    = '450x332'. $name_image;
					$imgUp->image_resize          = true;
					$imgUp->image_ratio_crop      = true;
					$imgUp->image_y               = 332;
					$imgUp->image_x               = 450;
...
if(!$OK) article("?".TTH_PATH."=article_edit", "edit", $article_id, $article_menu_id, $name, $slug, $title, $description, $keywords, $img, $img_note, $comment, $content, $is_active, $hot, $created_time, $upload_img_id, $error, $link);