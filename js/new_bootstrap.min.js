...
jQuery(document).ready(function(){
	...
	$('#primarynav').scrollToFixed();

    // Dock each summary as it arrives just below the docked header, pushing the
    // previous summary up the page.

    var summaries = $('.counseling-block');
    summaries.each(function(i) {
        var summary = $(summaries[i]);
        var next = summaries[i + 1];

        summary.scrollToFixed({
            marginTop: $('#primarynav').outerHeight(true) + 10,
            limit: function() {
                var limit = 0;
                if (next) {
                    limit = $(next).offset().top - $(this).outerHeight(true) - 10;
                } else {
                    limit = $('#botsl').offset().top - $(this).outerHeight(true) - 30;
                }
                return limit;
            },
            zIndex: 999
	...
	//Clone canvas menu
	var mobilemenu = $( "#menu-primary-menu" ).clone();
...
function display($type)
{
	if($type =='list')
	{
		...
		$('.mod-products').removeClass('grid');
		$('.product-desc').removeClass('hidden');
		$('.mod-products').addClass('list');
		...
		$('.mod-products').addClass('grid');
		$('.product-desc').addClass('hidden');
		$('.mod-products').removeClass('list');
...
jQuery(document).on("click", "#muangay", function(e) {
	$('#wpcf7-f129-p114-o1 #sanpham').val($('#product_name').val());
	$('#wpcf7-f129-p114-o1 #dongia').val(addCommas($('#product_price').val()));
	$('#muangay').fancybox(); 
});